...
/*
 $Log: eclipsesound.c,v $
 Revision 1.0  2019/06/14 egthomas
 Initial revision from interleavedsound
...
char cmdlne[1024];
char progid[80]={"$Id: eclipsesound.c,v 1.0 2019/06/14 egthomas Exp $"};
char progname[256];
...
int main(int argc,char *argv[]) {
  ...
  */
  ...
  /* For a 16-beam radar */
  int num_scans = 10;
  int forward_beams[10] = { 1,8,4,8,7,8,11,8,15,8 };
  int backward_beams[10]= { 15,7,12,7, 8, 7, 4, 7, 0 };
