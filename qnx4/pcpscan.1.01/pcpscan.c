...
/*
 $Log: normalscan.c,v $
 Revision 1.12  2012/01/17  21:42:45 DAndre
 Fixed the exitpoll condition during the single
 beam frequency sweep section. KTS applied.

 Revision 1.11  2011/12/20 22:00:23 kts
 Modification of normalscan with Todd's PCP code added in
...
#define PCPFNUM 8
#define PCPCPID 9211
int pcpfreqs[PCPFNUM]={8550, 9600, 10500, 11500, 13500, 14600, 15900, 17500};

int pcpcnt;

char cmdlne[1024];
char progid[80]={"$Id: pcpscan.c,v 1.11 2011/12/20 22:00:23 Exp $"};
char progname[256];
